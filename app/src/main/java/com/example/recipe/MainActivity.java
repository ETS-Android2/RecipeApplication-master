...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipes1.add(new Recipes("Chinese Roll","1 packet noodles as per the people" +
                ...
                "Chinese Roll is a delectable North Indian recipe made using all purpose flour, stir-fried chinese yoghurt and a variety of vegetables rolled into paranthas. On days you do not want to prepare an elaborate meal, this delectable dish can be a saviour. Rolls are quite popular across India and they are often a favourite evening snack. cheese Roll, Kathi Kebab Roll,Paneer Roll, Potato Roll and even are among its many variations. This easy roll recipe is made using chinese and has the unforgettable aroma of Indian spices. You can also utilize your leftover parathas and chapatis in making this recipe. If you do not like to use all-purpose flour or maida, you can make it with whole wheat flour too. In fact, it can be made even with leftover chinese. All you have to ensure is that you use the right amount of spices so that the flavour is not lost. Easy to pack and carry, you can also take it to office or prepare it for picnics and day trips. A must try roll recipe for all chinese lovers!\n",R.drawable.chinese));
        recipes1.add(new Recipes("Donut","1 c. whole milk" +
                ...
                "Transfer doughnuts to paper towel-lined baking sheet to drain and cool slightly. Dip into glaze, then place onto a cooling rack (or eat immediately!)",R.drawable.doonut));
        recipes1.add(new Recipes("Dosa","3 cups rice" +
                ...
                "The dosa is almost done. Fold it in half and allow to cook for 30 seconds more.",R.drawable.dhosa));
        recipes1.add(new Recipes("Pancake","1 1/4 cups milk" +
                ...
                "Heat a lightly oiled griddle or frying pan over medium high heat. Pour or scoop the batter onto the griddle, using approximately 1/4 cup for each pancake. Brown on both sides and serve hot.",R.drawable.pancakee));
        recipes1.add(new Recipes("Pasta","1 tsp oil" +
                ...
                "finally, serve masala pasta indian style hot topped with cheese if required.",R.drawable.pastaa));
